            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="single-con-info pt-50 pb-50">
                        <h6>DHAKA OFFICE</h6>
                        <p class="con-text">Asif House (2nd Floor), House#15,Road#4,Sector#9,Banani. Dhaka, Bangladesh 1230</p>
                        <p><span>Phone:</span> +88 01000000</p>
                ...
                <div class="col-md-6">
                    <div class="single-con-info pt-50 pb-50">
                        <h6>SYLHET OFFICE</h6>
                        <p class="con-text">House #14, Block #02 , Uposhohor , Sylhet, Bangladesh 3100</p>
                        <p><span>Phone:</span> +88 01000000</p>
                        <p><span>Email:</span> auroraphotography.bd@gmail.com</p>
                    </div>
                </div>
